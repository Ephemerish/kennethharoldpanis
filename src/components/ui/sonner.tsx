...
const Toaster = ({ ...props }: ToasterProps) => {
  return (
    <Sonner
      ...
      icons={{
        success: (
          <div className="w-5 h-5 bg-success-500 flex items-center justify-center">
        ...
        error: (
          <div className="w-5 h-5 bg-error-500 flex items-center justify-center">
            <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        warning: (
          <div className="w-5 h-5 bg-warning-500 flex items-center justify-center">
            <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        info: (
          <div className="w-5 h-5 bg-brand-600 flex items-center justify-center">
            <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
